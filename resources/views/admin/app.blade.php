    ...
    <div class="leftside-menu">
        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#bank" aria-expanded="false" aria-controls="sidebarPages" class="side-nav-link">
                        <i class="ri-pages-line"></i>
                        <span> Bank </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="bank">
                        <ul class="side-nav-second-level">
                            <li>
                                <a href="{{ route('bank.section') }}">Bank</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#currency" aria-expanded="false" aria-controls="sidebarPages" class="side-nav-link">
                        <i class="ri-pages-line"></i>
                        <span> Currency </span>
                        <span class="menu-arrow"></span>
                    </a>
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#product" aria-expanded="false" aria-controls="sidebarPages" class="side-nav-link">
                        <i class="ri-pages-line"></i>
                        <span> Product </span>
                        <span class="menu-arrow"></span>
                    </a>
